...
if __name__ == '__main__':
    ...
    outputs = []
    li2 = [1, 0.3, 0.1, 0.03, 0.01]
    for p1 in range(15, 16):
                p1 /= 10.
        # for p2 in range(0, 4):
        #         p2 /= 10.
            # for p3 in li2:
                ...
                processes = []
                for i in range(8):
                    process = subprocess.Popen('CUDA_VISIBLE_DEVICES={} python -u train.py --seed {}'.format(i, i), shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
